...
ProjectConfig::ProjectConfig(int projectId, const QString& projectName, const QString& windowLayout,
                             const QString& lightMapping, const QString& cronStrategy,
                             const QDateTime& createTime, int isValid)
    : m_projectId(projectId), m_projectName(projectName), m_windowLayout(windowLayout),
    m_lightMapping(lightMapping), m_cronStrategy(cronStrategy), m_createTime(createTime),
    m_isValid(isValid) {}
