...
public:
    ...
    virtual bool update(const LEDDB::SceneStatistic& stat) = 0;
    virtual bool deleteById(int statId) = 0;
    virtual std::optional<LEDDB::SceneStatistic> findById(int statId) = 0;
    virtual QList<LEDDB::SceneStatistic> findAll() = 0;
